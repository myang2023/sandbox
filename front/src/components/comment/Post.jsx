            ...
            <div className={`p-1 w-full mt-2`}>
                ...
                <form id='commentContext' className='flex flex-col gap-3 items-center'>
                    ...
                    <div className='flex gap-3'>
                        <div className={`${isAuthor === true ? 'bg-indigo-300' : ''} px-2 py-1 rounded-md border-2 border-indigo-300 hover:cursor-pointer`} onClick={() => setAuthor(true)}>作者</div>
                        <div className={`${isAuthor === false ? 'bg-indigo-300' : ''} px-2 py-1 rounded-md border-2 border-indigo-300 hover:cursor-pointer`} onClick={() => setAuthor(false)}>读者</div>
                    </div>
                    {
